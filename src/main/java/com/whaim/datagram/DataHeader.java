...
public class DataHeader {
    ...
    public String getOrigSendBCode() {
        return OrigSendBCode;
    }

    public void setOrigSendBCode(String origSendBCode) {
        OrigSendBCode = origSendBCode;
    }
    ...
    public String getOrigSenderType() {
        return OrigSenderType;
    }

    public void setOrigSenderType(String origSenderType) {
        OrigSenderType = origSenderType;
    }
    ...
    public String getOrigRecBCode() {
        return OrigRecBCode;
    }

    public void setOrigRecBCode(String origRecBCode) {
        OrigRecBCode = origRecBCode;
    }
    ...
    public String getOrigReceiverType() {
        return OrigReceiverType;
    }

    public void setOrigReceiverType(String origReceiverType) {
        OrigReceiverType = origReceiverType;
    }
    ...
    private String OrigSendBCode;
    private String OrigSenderSID;
    private String OrigSenderType;
    private String OrigReceiver;
    private String OrigRecBCode;
    private String OrigReceiverSID;
    private String OrigReceiverType;
